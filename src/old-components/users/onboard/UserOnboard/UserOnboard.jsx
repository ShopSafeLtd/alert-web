...
const UserOnboarding = ({ history, classes }) => {
  ...
  // globals
  const steps = [
    { step: 0, label: 'Welcome', url: '/onboard', next: 'Get Started' },
    {
      step: 1,
      label: 'Set Password',
      url: '/onboard/password',
      next: 'Set Password'
    },
    {
      step: 2,
      label: 'Account Details',
      url: '/onboard/account-details',
      next: 'Save Details'
    },
    {
      step: 3,
      label: 'Terms & Conditions',
      url: '/onboard/terms-conditions',
      next: 'Agree'
    }
  ];
  ...
  useEffect(() => {
    ...
    if (currentStep === 'PASSWORD') {
      history.push('/onboard/password');
      setStep(1);
    }
    if (currentStep === 'DETAILS') {
      history.push('/onboard/account-details');
      setStep(2);
    }
    if (currentStep === 'TERMS') {
      history.push('/onboard/terms-conditions');
      setStep(3);
    }
