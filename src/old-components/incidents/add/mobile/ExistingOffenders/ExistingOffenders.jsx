...
import ExistingOffendersList from '../ExistingOffendersList/ExistingOffendersList';
...
const ExistingOffenders = ({
  ...
  return (
    <Page>
      ...
      <SearchOffenders handleSearch={setSearch} search={search} />
      {loading ? (
        <div>
          <LoadingItem>
            <LoadingImage />
