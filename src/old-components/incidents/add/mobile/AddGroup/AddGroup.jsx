...
const AddGroup = ({ setNavbarAction, setBackLinkTo }) => {
  ...
  return (
    <Page>
        ...
        render={({ history }) => (
          <div>
            <Details
              ...
              back="/incidents/add/groups"
            />
            <FullWidthButton
              text="Next"
              onClick={() =>
                validateDetails().then(() =>
                  history.push('/incidents/add/groups/new/users')
                )
              }
            />
          </div>
      ...
      />
      <Route
        path="/incidents/add/groups/new/users"
        render={({ history }) => (
          <div>
            <Users
              setNavbarAction={setNavbarAction}
            ...
            <FullWidthButton
              ...
              onClick={async () => {
                ...
                history.push('/incidents/add/groups');
              }}
            />
          </div>
        )}
