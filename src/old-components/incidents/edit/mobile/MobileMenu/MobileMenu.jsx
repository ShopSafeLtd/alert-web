...
class MobileMenu extends PureComponent {
  componentDidMount() {
    this.props.setBackLinkTo('/incidents');
  }
  ...
  render() {
    ...
    return (
      <Menu>
        <MenuItem to={`/incidents/edit/${incidentId}/description`}>
        ...
        <MenuItem to={`/incidents/edit/${incidentId}/crime-types`}>
          <Svg viewBox="0 0 24 24">
            <path
              fill="#EF5350"
          ...
          <MenuItemText>Edit Crime Types</MenuItemText>
        </MenuItem>
        <MenuItem to={`/incidents/edit/${incidentId}/location`}>
          <Svg viewBox="0 0 24 24">
            <path
              fill="#EF5350"
          ...
          <MenuItemText>Edit Location</MenuItemText>
        </MenuItem>
        <MenuItem to={`/incidents/edit/${incidentId}/offenders`}>
          <Svg viewBox="0 0 24 24">
            <path
              fill="#EF5350"
          ...
          <MenuItemText>Edit Offenders</MenuItemText>
        </MenuItem>
        <MenuItem to={`/incidents/edit/${incidentId}/images`}>
          <Svg viewBox="0 0 24 24">
            <path
              fill="#EF5350"
        ...
        <MenuItem to={`/incidents/edit/${incidentId}/groups`}>
          <Svg viewBox="0 0 24 24">
            <path
              fill="#EF5350"
