...
import AddOffenderTag from 'components/form-components/tags/offenderWarnings/AddOffender';
      ...
      {loading ? (
        ...
        <Card>
          <Form
            onFinish={onSubmit}
            initialValues={{
              name: data?.offender?.name || '',
              age: data?.offender?.age || '',
              gender: data?.offender?.gender || '',
              race: data?.offender?.race || '',
              build: data?.offender?.build || '',
              hair: data?.offender?.hair || '',
              peculiarities: data?.offender?.peculiarities || '',
              // ageCheck: data?.offender?.dateOfBirth,
              dateOfBirth: data?.offender?.dateOfBirth || '',
              dateSource: data?.offender?.dateSource || '',
              groups:
              ...
              <Col span={11}>
                ...
                >
                  <Switch
                    ...
                    onChange={() => {
                      setAgeCheck(!data?.offender?.dateOfBirth);
                    }}
                  />
                </Form.Item>
              </Col>
