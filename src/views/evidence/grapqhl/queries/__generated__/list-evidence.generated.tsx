...
export const ListDemEvidenceExtendedWithoutUserDocument = gql`
  ...
  listDemEvidenceExtendedWithoutUser(where: $where, skip: $skip, take: $take) {
    ...
    `;
export function useListDemEvidenceExtendedWithoutUserQuery(baseOptions: Apollo.QueryHookOptions<ListDemEvidenceExtendedWithoutUserQuery, ListDemEvidenceExtendedWithoutUserQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListDemEvidenceExtendedWithoutUserQuery, ListDemEvidenceExtendedWithoutUserQueryVariables>(ListDemEvidenceExtendedWithoutUserDocument, options);
      }
export function useListDemEvidenceExtendedWithoutUserLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListDemEvidenceExtendedWithoutUserQuery, ListDemEvidenceExtendedWithoutUserQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListDemEvidenceExtendedWithoutUserQuery, ListDemEvidenceExtendedWithoutUserQueryVariables>(ListDemEvidenceExtendedWithoutUserDocument, options);
        }
