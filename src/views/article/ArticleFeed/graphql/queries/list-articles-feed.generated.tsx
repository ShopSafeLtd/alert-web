...
export type ListArticlesFeedQuery = {
  __typename?: 'Query';
  listArticlesRelay: {
...
`;
export function useListArticlesFeedQuery(
  ...
  return Apollo.useQuery<ListArticlesFeedQuery, ListArticlesFeedQueryVariables>(
    ListArticlesFeedDocument,
    options
  );
}
export function useListArticlesFeedLazyQuery(
  ...
  return Apollo.useLazyQuery<
    ListArticlesFeedQuery,
    ListArticlesFeedQueryVariables
  >(ListArticlesFeedDocument, options);
}
export type ListArticlesFeedQueryHookResult = ReturnType<
  typeof useListArticlesFeedQuery
>;
export type ListArticlesFeedLazyQueryHookResult = ReturnType<
  typeof useListArticlesFeedLazyQuery
>;
export type ListArticlesFeedQueryResult = Apollo.QueryResult<
  ListArticlesFeedQuery,
  ListArticlesFeedQueryVariables
>;
