...
export const ChecklistsDocument = gql`
  query Checklists(
    ...
    $order: ChecklistOrderByWithRelationInput
    $take: Int
    $skip: Int
  ) {
...
export function useChecklistsQuery(
  ...
  return Apollo.useQuery<ChecklistsQuery, ChecklistsQueryVariables>(
    ChecklistsDocument,
    options
  );
}
export function useChecklistsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ChecklistsQuery, ChecklistsQueryVariables>(
    ChecklistsDocument,
    options
  );
}
export type ChecklistsQueryHookResult = ReturnType<typeof useChecklistsQuery>;
export type ChecklistsLazyQueryHookResult = ReturnType<
  typeof useChecklistsLazyQuery
>;
export type ChecklistsQueryResult = Apollo.QueryResult<
  ChecklistsQuery,
  ChecklistsQueryVariables
>;
