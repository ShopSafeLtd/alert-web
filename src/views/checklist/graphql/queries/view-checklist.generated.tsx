...
export type ChecklistQuery = {
  ...
  checklist: {
    ...
    business: Array<{ __typename?: 'Business'; id: string }>;
  };
};
...
export function useChecklistQuery(
  baseOptions: Apollo.QueryHookOptions<ChecklistQuery, ChecklistQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ChecklistQuery, ChecklistQueryVariables>(
    ChecklistDocument,
    options
  );
}
export function useChecklistLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ChecklistQuery, ChecklistQueryVariables>(
    ChecklistDocument,
    options
  );
}
export type ChecklistQueryHookResult = ReturnType<typeof useChecklistQuery>;
export type ChecklistLazyQueryHookResult = ReturnType<
  typeof useChecklistLazyQuery
>;
export type ChecklistQueryResult = Apollo.QueryResult<
  ChecklistQuery,
  ChecklistQueryVariables
>;
