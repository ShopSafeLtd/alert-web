...
export type CreateDashboardMutation = {
  ...
  createDashboard: {
    ...
    id: string;
    name?: string | null;
    roles: Array<{ __typename?: 'CustomRole'; name: string; id: string }>;
  };
};
...
export type DeleteDashboardMutation = {
  __typename?: 'Mutation';
  deleteDashboardTemplate?: { __typename?: 'Dashboard'; id: string } | null;
};
...
export type UpdateDashboardTemplateMutation = {
  __typename?: 'Mutation';
...
`;
export type UpdateDashboardTemplateMutationFn = Apollo.MutationFunction<
  UpdateDashboardTemplateMutation,
  UpdateDashboardTemplateMutationVariables
>;
export function useUpdateDashboardTemplateMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateDashboardTemplateMutation,
    UpdateDashboardTemplateMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateDashboardTemplateMutation,
    UpdateDashboardTemplateMutationVariables
  >(UpdateDashboardTemplateDocument, options);
}
export type UpdateDashboardTemplateMutationHookResult = ReturnType<
  typeof useUpdateDashboardTemplateMutation
>;
export type UpdateDashboardTemplateMutationResult =
  Apollo.MutationResult<UpdateDashboardTemplateMutation>;
export type UpdateDashboardTemplateMutationOptions = Apollo.BaseMutationOptions<
  UpdateDashboardTemplateMutation,
  UpdateDashboardTemplateMutationVariables
>;
