...
interface WatchlistInsightsProps {
  insights:
    | StoreColleagueDashboardQuery['storeColleagueDashboard']['watchlistInsights']
    | null
    | undefined;
  loading: boolean;
}

const WatchlistInsights: React.FC<WatchlistInsightsProps> = ({
  insights,
  loading,
}) => {
  const intl = useIntl();
