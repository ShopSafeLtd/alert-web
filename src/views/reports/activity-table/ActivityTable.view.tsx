...
import { Badge, Button, Col, Drawer, Form, Input, Row, Select } from 'antd';
...
import ActivityTableLayout from './layout/ActivityTableLayout';
          ...
          >
            <ComponentList
              components={LayoutToReadable.filter(
                ...
                .filter(({ reportViews }) =>
                  reportViews.includes('activity_table')
                )
                .map((item) => ({
            ...
            <Form layout="vertical">
              <Form.Item
                label={intl.formatMessage({
                  defaultMessage: 'Activities in date range',
                })}
              >
                <DateSelect
              ...
              <Form.Item
                label={intl.formatMessage({
                  defaultMessage: 'Activities in assigned users',
                })}
              >
                <UsersSelect
                  mode="multiple"
              ...
              <Form.Item
                label={intl.formatMessage({
                  defaultMessage: 'Activities in businesses',
                })}
              >
                <BusinessesSelect
                  maxTagCount="responsive"
              ...
              <Form.Item
                label={intl.formatMessage({
                  defaultMessage: 'Activities in brands',
                })}
              >
                <BrandsSelect
                  maxTagCount="responsive"
              ...
              <Form.Item
                label={intl.formatMessage({
                  defaultMessage: 'Activities in industries',
                })}
              >
                <IndustrySelect
                  maxTagCount="responsive"
