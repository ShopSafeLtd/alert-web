...
import InvestigationTableLayout from './layout/InvestigationTableLayout';
          ...
          {editMode ? (
            ...
            <div>
              ...
              <GeneratePrintPage
                ...
                elements={InvestigationTableLayout({
                  changeSize,
                  data,
                  editMode,
                  filters: {
          ...
          >
            <ComponentList
              components={LayoutToReadable.filter(
                ...
                .filter(({ reportViews }) =>
                  reportViews.includes('investigation_table')
                )
                .map((item) => ({
            ...
            <Form layout="vertical">
              <Form.Item
                label={intl.formatMessage({
                  defaultMessage: 'Investigations in date range',
                })}
              >
                <DateSelect
              ...
              >
                <Select
                  ...
                  value={status}
                >
                  <Select.Option value={InvestigationStatus.Open}>
                    <FormattedMessage defaultMessage="Open" />
                  </Select.Option>
                  <Select.Option value={InvestigationStatus.Closed}>
                    <FormattedMessage defaultMessage="Closed" />
                  </Select.Option>
                  <Select.Option value={InvestigationStatus.Paused}>
