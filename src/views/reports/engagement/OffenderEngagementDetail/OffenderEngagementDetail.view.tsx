...
import useStyles from './OffenderEngagementDetail.styles';
...
interface OffenderEngagementDetailViewProps {
...
const OffenderEngagementDetailView: React.FC<
  OffenderEngagementDetailViewProps
> = ({
  engagementData,
  filterStatus,
  filteredUsers,
      ...
      <div className={classes.header}>
        ...
        <div className={classes.titleContainer}>
          ...
          <Title level={2} style={{ margin: 0 }}>
            {engagementData?.offenderName || (
              <FormattedMessage defaultMessage="Offender Engagement" />
            )}
          </Title>
        </div>
      </div>
...
export default OffenderEngagementDetailView;
