...
import useStyles from './BulletinEngagementDetail.styles';
...
interface BulletinEngagementDetailViewProps {
...
const BulletinEngagementDetailView: React.FC<
  BulletinEngagementDetailViewProps
> = ({
  engagementData,
  filterStatus,
  filteredUsers,
      ...
      <div className={classes.header}>
        ...
        <div className={classes.titleContainer}>
          ...
          <Title level={2} style={{ margin: 0 }}>
            {engagementData?.bulletinTitle || (
              <FormattedMessage defaultMessage="Bulletin Engagement" />
            )}
          </Title>
        </div>
      </div>
...
export default BulletinEngagementDetailView;
