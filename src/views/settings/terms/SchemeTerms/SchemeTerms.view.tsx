    ...
    <Card style={{ width: '98%' }}>
      <Space direction="vertical" style={{ fontSize: 12 }} size={1}>
        ...
        <Paragraph>
          ...
          asset protection and staff security. The Alert! App provides quick and
          intuitive access to data and intelligence regarding those that attempt
          to commit crime, and a means to report acts of crime and anti-social
          behaviour shared amongst a closed group of users.
        </Paragraph>
        ...
        <Paragraph>
          ...
          Administration rights to enable the Users to access the Alert! system
        </Paragraph>
        ...
        <Paragraph>
          ...
          requirements of Article 28 of the General Data Protection Regulation.
        </Paragraph>
        ...
        <Paragraph>
          The “UK GDPR” is the General Data Protection Regulations, tailored by
          the Data Protection Act 2018 (and referred to as the “Applicable
          Law”).
        </Paragraph>

        <Paragraph>
          &quot;Personal Data&quot; includes any information relating to an
          identified or identifiable natural person as defined in GDPR, article
          4 (1) (1) (the ”Personal Data”).
        </Paragraph>

        <Paragraph>
          “Data Subject” shall mean a person who can be identified, directly or
          indirectly, by reference to an identification number or to factors
          specific to his or her physical, physiological, mental, economic,
          cultural or social identity.
        </Paragraph>

        <Paragraph>
          The “Purpose” of the processing under this Agreement is the provision
          of the Services by the Data Processor as specified in Section 3 of
          this agreement.
        </Paragraph>
        ...
        <Text>
          3.2 ShopSafe will configure, manage and maintain workspace to provide
          the Service on the servers for the Organisation; assist in the
          Administration role to enable Users; provide training support material
          for the Users; and provide any template documents as necessary for the
          Client to provide the service.
        </Text>
        <Text>
          3.3 ShopSafe will provide continuous telephone and email support on a
          24/7/365 basis via our HelpDesk.
        </Text>
        <Text>
          ...
          safety; anonymise it as required and delete it irrevocably to meet the
          Organisation’s rules and protocols in compliance with the UK GDPR
          legislation.
        </Text>
        <Text>
          3.5 The Data Processor Agreement shall ensure that the Data Processor
          complies with the applicable data protection and privacy legislation
          and in particular the General Data Protection Regulation (GDPR)
          (Regulation (EU) 2016/679) the Applicable Law.
        </Text>
        <Text>
        ...
        <Text>
          ...
          are necessary and relevant to perform the Services outlined in Section
          3.
        </Text>
        <Text>
        ...
        <Text>
          ...
          process the Personal Data with the purpose of delivering the Services
          as described in Section 3. Subject to the terms of this DPA and with
          mutual agreement of the parties, the Data Controller may issue
          additional written instructions consistent with the terms of this
          Agreement. The Data Controller is responsible for ensuring that all
          individuals who provide written instructions are authorised to do so.
        </Text>
        <Text>
          ...
          Regulations. The Data Controller’s instructions for the processing of
          Personal Data shall comply with Applicable Law. The Data Controller
          will have sole responsibility for the accuracy, quality, and legality
          of Personal Data and the means by which it was obtained.
        </Text>
        <Text>
        ...
        <Text>
          ...
          Controller and will not execute the instructions until they have been
          confirmed or modified. If ShopSafe deems not to execute an
          Instruction, not to process or subsequently delete that data they will
        ...
        <Text>
          ...
          data and the data retention periods agreed with the Data Processor and
          how this period might vary in some circumstances. This Policy must
          form part of the User’s Membership Agreement. The Members must have
        ...
        <Text>
          ...
          This Terms of Use will include the members responsibilities to comply
          to the UK GDPR legislation referred to as the Applicable Law; the
          Members responsibilities to ensure security of the system; and that
          data submitted must be fair and neither discriminatory nor defamatory
          as making a false or malicious report may itself be a crime.
        </Text>
        <Text>
          5.3 The Member must also be made aware and agree to the use of audit
          trails that monitors use and compliance within Alert!, and that emails
          and telephone calls may be recorded to ensure compliance. The User
          must also agree to prevent unauthorised access to the system; of the
          need for confidentiality and security in respect of passwords to
          prevent unauthorised access to the Service and their responsibilities
          not to disclose the password, grant or share access by any other
          means.
        </Text>
        <Text>
          ...
          consent would make the Member (and not the Data Controller) guilty of
          an offence under Data Protection Law.
        </Text>
        <Text>
          5.5 The Data Controller agrees that any User or Member that fails to
          comply with their Personal Data Processing Policy, the Alert! Terms of
          Use, or fails to reaffirm their compliance on signing in to the Alert!
          App or suspected of a breach or potential breach will be prevented
        ...
        <Text style={{ marginLeft: '12px' }}>
          ...
          require access to such Personal Data for the delivery of the Services
          and this Data Processor Agreement.
        </Text>
        <Text>
          6.2 ShopSafe shall ensure that employees processing the Personal Data
          only process the Personal Data in accordance with the Instruction.
        </Text>
        ...
        <Text style={{ marginLeft: '12px' }}>
          6.3.2 ShopSafe shall provide documentation for such security measures
          if requested by the Data Controller in writing.
        </Text>
        <Text>
        ...
        <Text style={{ marginLeft: '12px' }}>
          ...
          ShopSafe shall assist the Data Controller in preparing data protection
          impact assessments in accordance with GDPR Article 35, along with any
          prior consultation in accordance with GDPR, Article 36.
        </Text>
        <Text>6.5 Rights of the Data Subjects</Text>
        <Text style={{ marginLeft: '12px' }}>
          6.5.1 If the Data Controller receives a request from a Data Subject
          for the exercise of the Data Subject’s rights under the Applicable Law
          and the correct and legitimate reply to such a request necessitates
          the Data Processor’s assistance, ShopSafe shall assist the Data
          Controller by providing the necessary information and documentation.
          ShopSafe shall be given reasonable time to assist the Data Controller
          with such requests in accordance with the Applicable Law.
        </Text>
        <Text style={{ marginLeft: '12px' }}>
        ...
        <Text style={{ marginLeft: '12px' }}>
          6.6.1 ShopSafe shall give immediate notice to the Data Controller if a
          breach occurs, that can lead to the accidental or unlawful
          ...
          Personal Data processed on behalf of the Data Controller (a “Personal
          Data Breach”).
        </Text>
        <Text style={{ marginLeft: '12px' }}>
          6.6.2 ShopSafe shall make reasonable efforts to identify the cause of
          such a breach and take those steps as they deem necessary to establish
          the cause, and to prevent such a breach from reoccurring.
        </Text>
        <Text style={{ marginLeft: '12px' }}>
        ...
        <Text style={{ marginLeft: '12px' }}>
          6.7.1 Upon request by a Data Controller, the Data Processor shall make
          available to the Data Controller all relevant information necessary to
          demonstrate compliance with this DPA, and shall allow for and
          reasonably cooperate with audits, including inspections by the Data
          Controller or an auditor mandated by the Data Controller. The Data
          Controller shall give notice of any audit or document inspection to be
          conducted and shall make reasonable endeavors to avoid causing damage
          or disruption to ShopSafeAlert’s premises, equipment and business in
          the course of such an audit or inspection. Any audit or document
          inspection shall be carried out with reasonable prior written notice
          of no less than 30 days and shall not be conducted more than once a
          year.
        </Text>
        <Text style={{ marginLeft: '12px' }}>
        ...
        <Text>
          7.1 ShopSafe is given general authorisation to engage third-parties to
          process the Personal Data (“Sub-Processors”) without obtaining any
          further written, specific authorization from the Data Controller,
          provided that ShopSafe notifies the Data Controller in writing about
          the identity of a potential Sub-Processor (and its processors, if any)
          before any agreements are made with the relevant Sub-Processors and
          before the relevant Sub-Processor processes any of the Personal Data.
          If the Data Controller wishes to object to the relevant Sub-Processor,
          the Data Controller shall give notice hereof in writing within ten
        ...
        <Text>
          ...
          ShopSafe may terminate the Services by providing written notice to the
          Data Controller.
        </Text>
        <Text>
          7.3 ShopSafe shall complete a written sub-processor agreement with any
          Sub-Processors. Such an agreement shall at minimum provide the same
          data protection obligations as the ones applicable to the Data
          ...
          Documentation of such monitoring and control shall be provided to the
          Data Controller if so requested in writing.
        </Text>
        <Text>
        ...
        <Text>
          ...
          Processor initiates sub-processing with a new Sub-Processor, such new
          Sub-Processor shall be added to the list in Appendix B under paragraph
          2.
        </Text>
        ...
        <Text>
          8.1 The Data Controller shall remunerate ShopSafe based on time spent
          to perform the obligations under section 6.4, 6.5, 6.6, 6.7 and 6.8 of
          this Data Processor Agreement based on ShopSafe’s hourly rates of £70.
        </Text>
        <Text>
          8.2 ShopSafe is also entitled to remuneration for any time and
          material used to adapt and change the processing activities to comply
          with any changes to the Data Controller’s Instruction, including
          implementation costs and additional costs required to deliver the
          Services due to the change in the Instruction. ShopSafe is exempted
          from liability for non-performance if the performance of the
          obligations would be in conflict with any changed Instruction or if
          contractual delivery in accordance with the changed Instruction is
          impossible. This could for instance be the case:
        </Text>
        <Text style={{ marginLeft: '12px' }}>
          (i) if the changes to the Instruction cannot technically, practically
          or legally be implemented
        </Text>

        <Text style={{ marginLeft: '12px' }}>
          (ii) where the Data Controller explicitly requires that the changes to
          the Instruction shall be applicable before the changes can be
          implemented; and
        </Text>

        <Text style={{ marginLeft: '12px' }}>
          (iii) in the period of time until the Agreement is changed to reflect
        ...
        <Text>
          ...
          any cost. In such circumstances the Data Controller will remain liable
          to meet all costs due.
        </Text>
        <Text>
          ...
          extent the Data Processor is required by Applicable law to retain some
          or all of the Personal Data (in which case the Data Processor will
          archive the data and implement reasonable measures to prevent the
          Personal Data from any further processing). The terms of this DPA will
          continue to apply to such Personal Data.
        </Text>
        <Text>
          11.3 Either party may terminate the Contract if the other becomes
          bankrupt, insolvent, goes into liquidation, makes an arrangement with
          its creditors or a receiving or administration order is made.
        </Text>
        <Text>
          11.4 In the event of any failure of the service, ShopSafe will not be
          liable to the Data Controller or any other party for any special,
          indirect, or consequential damages, including but not limited to loss
          of revenue, business, anticipated savings or profit, loss of goodwill,
          loss or corruption of data or any other economic loss or any indirect
          or consequential loss whatsoever or howsoever arising even if the Data
          Controller has notified ShopSafe that any of the above may occur.
        </Text>
        <Text>
        ...
        <Text>
          12.3 This Agreement represents the entire understanding of the parties
          relating to necessary legal protections arising out of their Data
          Controller/Processor relationship under Data Protection Laws.
        </Text>
        <Text>
        ...
        <Text style={{ marginLeft: '12px' }}>
          1.1 Information on offenders submitted to Alert! by users and approved
        ...
        <Text style={{ marginLeft: '12px' }}>
          1.2 Information on users of Alert! as approved by the Data Controller
        ...
        <Text>
          The following Sub-Processors shall be considered approved by the Data
          Controller at the time of entering into this Agreement:
        </Text>
        <Text style={{ marginLeft: '12px' }}>
        ...
        <Text style={{ marginLeft: '12px' }}>
          ii. Image Manipulation Services & Secure Hosting: Cloudinary Inc., 111
          W Evelyn Avenue, Suite 206, Sunnyvayle, CA 94086
        </Text>
        <Text style={{ marginLeft: '12px' }}>
        ...
        <Paragraph>
          The Data Controllers’ Representative shall be <strong>[ ... ]</strong>{' '}
          or such other person as shall be notified by the Data Controller.
        </Paragraph>
      </Space>
    </Card>
  </div>
