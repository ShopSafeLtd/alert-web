...
const RecycleBin = ({
  ...
  <div className="list-view">
    <Row style={{ margin: 10 }}>
      <Col>
        <Typography.Title level={3}>Recycle Bin</Typography.Title>
        <Typography.Text>
          Deleted items will be stored here for 30 days, then permanently
          deleted. Items can be restored at any point before that.
        </Typography.Text>
      </Col>
    </Row>
