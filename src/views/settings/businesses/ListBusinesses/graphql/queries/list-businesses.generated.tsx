...
`;
export function useBusinessesListQuery(
  ...
  return Apollo.useQuery<BusinessesListQuery, BusinessesListQueryVariables>(
    BusinessesListDocument,
    options
  );
}
export function useBusinessesListLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<BusinessesListQuery, BusinessesListQueryVariables>(
    BusinessesListDocument,
    options
  );
}
export type BusinessesListQueryHookResult = ReturnType<
  typeof useBusinessesListQuery
>;
export type BusinessesListLazyQueryHookResult = ReturnType<
  typeof useBusinessesListLazyQuery
>;
export type BusinessesListQueryResult = Apollo.QueryResult<
  BusinessesListQuery,
  BusinessesListQueryVariables
>;
