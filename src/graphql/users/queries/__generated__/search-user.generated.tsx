...
export type SearchUserQuery = { __typename?: 'Query', user: { __typename?: 'User', id: string, fullName: string, email: string, publicName: boolean, reportToAllBusinesses: boolean, businesses: Array<{ __typename?: 'Business', id: string, name: string, locations: Array<{ __typename?: 'Address', id: string, full: string }> }>, addresses: Array<{ __typename?: 'Address', id: string, postcode?: string | null, street?: string | null, townCity?: string | null, building?: string | null, county?: string | null }> } };
