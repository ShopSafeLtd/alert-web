...
export const SchemeUsersDocument = gql`
  ...
  users(
    ...
    `;
export function useSchemeUsersQuery(baseOptions?: Apollo.QueryHookOptions<SchemeUsersQuery, SchemeUsersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SchemeUsersQuery, SchemeUsersQueryVariables>(SchemeUsersDocument, options);
      }
export function useSchemeUsersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SchemeUsersQuery, SchemeUsersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SchemeUsersQuery, SchemeUsersQueryVariables>(SchemeUsersDocument, options);
        }
export type SchemeUsersQueryHookResult = ReturnType<typeof useSchemeUsersQuery>;
export type SchemeUsersLazyQueryHookResult = ReturnType<typeof useSchemeUsersLazyQuery>;
export type SchemeUsersQueryResult = Apollo.QueryResult<SchemeUsersQuery, SchemeUsersQueryVariables>;