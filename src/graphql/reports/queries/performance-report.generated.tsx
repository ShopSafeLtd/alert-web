...
export type PerformanceReportQuery = {
  ...
  performanceReport: {
    ...
    outcomeSummary: {
      ...
      totalArrests: number;
      totalCBOYears: number;
      totalCBOCount: number;
      totalFinesCount: number;
      totalFinesValue: number;
      totalPrisonSentenceCount: number;
      totalPrisonSentenceMonths: number;
      totalRehabOrders: number;
    };
    ...
    policeSummary: {
      ...
      totalAttendedIncidents: number;
      totalReportedIncidents: number;
      totalPoliceImages: number;
      totalVerifiedOffenders: number;
    };
    ...
    timeHeatMap: Array<{
      ...
      id: string;
      data: Array<{ __typename?: 'HourCountXY'; x: string; y: number }>;
    }>;
    priorityGraph: Array<{
      __typename?: 'Graph';
      value: number;
  ...
  investigationPerformance: {
    ...
    total: number;
    investigationPerformance: Array<{
