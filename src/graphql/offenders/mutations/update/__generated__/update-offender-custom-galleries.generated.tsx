...
export const UpdateOffenderCustomGalleriesDocument = gql`
    mutation updateOffenderCustomGalleries($id: String!, $customGalleries: NestedCustomGalleryOnOffender) {
  updateOffender(where: {id: $id}, data: {customGalleries: $customGalleries}) {
    id
    customGalleries {
      id
      name
    ...
    `;
export type UpdateOffenderCustomGalleriesMutationFn = Apollo.MutationFunction<UpdateOffenderCustomGalleriesMutation, UpdateOffenderCustomGalleriesMutationVariables>;
export function useUpdateOffenderCustomGalleriesMutation(baseOptions?: Apollo.MutationHookOptions<UpdateOffenderCustomGalleriesMutation, UpdateOffenderCustomGalleriesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateOffenderCustomGalleriesMutation, UpdateOffenderCustomGalleriesMutationVariables>(UpdateOffenderCustomGalleriesDocument, options);
      }
