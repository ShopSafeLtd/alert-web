...
export type CurrentUserQueryVariables = Types.Exact<{
  ...
  orderBy?: Types.InputMaybe<
    | Array<Types.UserSchemeOrderByWithRelationInput>
    | Types.UserSchemeOrderByWithRelationInput
  >;
}>;
...
export type CurrentUserQuery = {
  ...
  currentUser?: {
    ...
    schemes: Array<{
      ...
      scheme: {
        __typename?: 'Scheme';
        customTranslations: Array<{ [key: string]: any }>;
        userTodos: number;
        id: string;
        name: string;
        goodsMode: Types.GoodsMode;
