...
export function useMentionableUsersQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MentionableUsersQuery,
    MentionableUsersQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MentionableUsersQuery, MentionableUsersQueryVariables>(
...
export function useMentionableUsersLazyQuery(
  ...
  return Apollo.useLazyQuery<
    MentionableUsersQuery,
    MentionableUsersQueryVariables
  >(MentionableUsersDocument, options);
}
export type MentionableUsersQueryHookResult = ReturnType<
  typeof useMentionableUsersQuery
>;
export type MentionableUsersLazyQueryHookResult = ReturnType<
  typeof useMentionableUsersLazyQuery
>;
