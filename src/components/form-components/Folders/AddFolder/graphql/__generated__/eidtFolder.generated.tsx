...
export type EditFolderQuery = { __typename?: 'Query', folder: { __typename?: 'Folder', id: string, name: string, parentFolderId?: string | null, description?: string | null, totalDocuments: number, totalChildFolders: number, roles: Array<{ __typename?: 'CustomRole', id: string }>, documents: Array<{ __typename?: 'Document', id: string, name: string, url: string, thumbnailUrl?: string | null, createdAt: Date, tags: Array<{ __typename?: 'Tag', id: string, name: string }> }>, childFolders: Array<{ __typename?: 'Folder', id: string, name: string, description?: string | null, totalDocuments: number, totalChildFolders: number, documents: Array<{ __typename?: 'Document', id: string, name: string, url: string, thumbnailUrl?: string | null, createdAt: Date, tags: Array<{ __typename?: 'Tag', id: string, name: string }> }> }> } };
