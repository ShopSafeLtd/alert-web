...
export type UserParentRolesQuery = { __typename?: 'Query', user: { __typename?: 'User', id: string, fullName: string, schemes: Array<{ __typename?: 'UserScheme', id: string, schemeId: string, orignalPermissions: { __typename?: 'CustomRole', id: string, parentId?: string | null } }> } };
