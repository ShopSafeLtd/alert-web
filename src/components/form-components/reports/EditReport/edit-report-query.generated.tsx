...
export type EditReportTemplateQuery = { __typename?: 'Query', reportTemplate: { __typename?: 'ReportTemplate', id: string, name: string, description?: string | null, groups: Array<{ __typename?: 'Group', id: string, name: string }> } };
